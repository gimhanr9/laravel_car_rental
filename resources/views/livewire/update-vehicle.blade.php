<div>
    <form wire:submit.prevent="update" enctype="multipart/form-data">
            ...
            <div class="form-group col-md-6">
              ...
              <input type="text" class="form-control" id="inputEmail4" wire:model="model">
            ...
            <option> Chrylser </option>
              ...
              <div class="form-group col-md-6">
                ...
                <input type="text" class="form-control" id="inputEmail4" wire:model="cost">
                @error('cost') <span class="text-danger">{{ $message }}</span> @enderror
              </div>
  
              <div class="form-group col-md-6">
                <label for="inputEmail4">Year</label>
                <input type="text" class="form-control" id="inputEmail4" wire:model="year">
            ...
            <option> MPV </option>
                  ...
                  <div class="form-group">
                    ...
                    <textarea class="form-control" id="exampleInputbody" wire:model="description"></textarea>
